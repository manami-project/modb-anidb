...
internal fun main() {
    ...
    runCoroutine {
        ...
        downloader.download("14872").writeToFile(resourceFile("file_converter_tests/anime_season/season/start_date_cell_mar.html"))
        ...
        downloader.download("12676").writeToFile(resourceFile("file_converter_tests/anime_season/season/date_published_cell_jun.html"))
